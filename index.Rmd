...
2. A packages insistence on using factors may cause you to lose your mind.
...
[ignore if you're not into programming]
...
* Consider non-linear approaches like tree-based and Naive Bayes
* MCA can address "curse of dimensionality" with categorical data
* Don't lose heart! Fitting categorical data is hard. Research is light.

##

All of the code - even stuff you didn't see - is on GitHub

github.com/pirategrunt/sparsity_blues
